...
class EvaluationService:
    ...
    def seed_default_cases(self, db: Session) -> None:
        ...
        defaults = [
            {
                "question": "供应商准入前必须收集哪些基础材料？",
                "expected_answer": "需要收集营业执照、法定代表人信息、银行账户证明、税务登记信息和最近一期审计报告。",
                "expected_document_title": "procurement_cn_vendor_onboarding_policy.md",
                "task_type": "support",
                "required_role": "employee",
                "knowledge_domain": "vendor_onboarding",
            },
            {
                "question": "比较标准主服务协议与供应商红线版本在核心条款上的差异。",
                "expected_answer": "供应商红线版本弱化了责任上限、缺少审计权和便利终止等核心条款。",
            ...
            },
            {
                ...
                "expected_answer": "第一步是创建安全评审工单，并附上问卷、产品架构图和数据流说明。",
                "expected_document_title": "procurement_cn_security_review_sop.md",
                "task_type": "workflow",
                "required_role": "employee",
            ...
            },
            {
                ...
                "expected_answer": "删除或弱化责任上限、删除审计权、涉及个人信息或跨境数据处理等情况必须升级法务审批。",
                "expected_document_title": "procurement_cn_approval_matrix.md",
                "task_type": "support",
                "required_role": "employee",
