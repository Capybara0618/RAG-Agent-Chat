...
class ProcurementProject(Base):
    ...
    procurement_materials_json: Mapped[str] = mapped_column(Text, default="{}")
...
class VendorCandidate(Base):
    ...
    handles_company_data: Mapped[bool] = mapped_column(Boolean, default=False)
    requires_system_integration: Mapped[bool] = mapped_column(Boolean, default=False)
